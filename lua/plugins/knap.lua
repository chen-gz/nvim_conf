return {
    {
        ...
        config = function()
            ...
            vim.g.knap_settings = {
                ...
                textopdfviewerrefresh = "none",
                textopdfforwardjump = "zathura --synctex-forward=%line%:%column%:%srcfile% %outputfile%",
                delay = 20000, -- You can adjust this delay if needed
                outputcmd =
                "tempout=\"/tmp/$(basename %outputfile%)\" ; pandoc --citeproc --bibliography=mybib.yaml -o \"$tempout\" %docroot% && mv \"$tempout\" %outputfile%"
            }
